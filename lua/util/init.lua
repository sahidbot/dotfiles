...
-- cwd will default to nyxvim.util.get_root
...
function M.deprecate(old, new)
  Util.warn(("`%s` is deprecated. Please use `%s` instead"):format(old, new), { title = "NyxVim" })
end
...
function M.changelog()
  local lv = require("lazy.core.config").plugins.NyxVim
